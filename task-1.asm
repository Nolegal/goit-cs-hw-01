...
_start:
    ...
    sub al, [c] ; Додаємо значення по адресі [с] у регістр al та збергігаємо результат в al 
    add al, [a] ; Віднімаємо значення по адресі [a] у регістр al та збергігаємо результат в al 
